...
const CourseForm = dynamic(() => import("@/components/instructor/CourseForm"), {
  ssr: false,
});
const LessonForm = dynamic(() => import("@/components/instructor/LessonForm"), {
  ssr: false,
});
const AssignmentForm = dynamic(
  () => import("@/components/instructor/AssignmentForm"),
  { ssr: false }
);
...
export default function InstructorDashboard() {
  const [activeTab, setActiveTab] = useState<
    "overview" | "courses" | "lessons" | "assignments"
  >("overview");
  ...
  const handleDeleteCourse = async (courseId: string) => {
    if (
      confirm(
        "Are you sure you want to delete this course? This will also delete all related lessons and assignments."
      )
    ) {
      try {
  ...
  const handleSaveAssignment = async (
    ...
    try {
      ...
      if (editingAssignment) {
        ...
        setAssignments([
          ...assignments,
          { ...assignmentData, id: newAssignment.id },
        ]);
      }
        ...
        <div className="space-y-3">
          <div className="flex items-center space-x-3 p-3 bg-blue-50 rounded-lg">
            ...
            <span className="text-gray-700">
              Course &quot;React Fundamentals&quot; was updated
            </span>
          ...
          <div className="flex items-center space-x-3 p-3 bg-green-50 rounded-lg">
            ...
            <span className="text-gray-700">
              New lesson &quot;Introduction to React&quot; was added
            </span>
          ...
          <div className="flex items-center space-x-3 p-3 bg-purple-50 rounded-lg">
            ...
            <span className="text-gray-700">
              Assignment &quot;Build a Todo App&quot; was created
            </span>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Please wait while we load your courses, lessons, and assignments.
          </p>
        </div>
      </div>
    );
